...
SELECT 
  ...
  ROUND(AVG(templates_used), 3) AS avg_templates_used_per_customer,
  ROUND(SUM(CASE WHEN templates_used > 1 THEN 1 ELSE 0 END) / COUNT(customer_id), 3) AS perc_customers_using_multiple_templates
